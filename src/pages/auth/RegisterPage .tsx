  ...
  return (
    <div className="container mx-auto px-4 py-16 flex flex-col items-center justify-center min-h-screen">
      ...
      >
        {/* Geometric shapes */}
        <motion.div
          className="absolute top-0 right-0 w-24 h-24 bg-purple-200 rounded-full mix-blend-multiply filter blur-lg opacity-50"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, -90, 0],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-0 left-0 w-20 h-20 bg-yellow-200 rounded-full mix-blend-multiply filter blur-lg opacity-50"
          animate={{
            scale: [1, 1.3, 1],
            rotate: [0, 90, 0],
          }}
        ...
        <form className="space-y-4">
          <div>
            ...
            <Input type="text" id="name" placeholder="Enter your name" className="bg-gray-50" />
          </div>
          <div>
          ...
          <div>
            ...
            <Input type="password" id="confirm-password" placeholder="Confirm your password" className="bg-gray-50" />
          </div>
          <Button type="submit" className="w-full bg-gray-900 text-white hover:bg-gray-800">Register</Button>
        </form>
        <div className="mt-6">
          <p className="text-center mb-4 text-gray-600">Or register with</p>
